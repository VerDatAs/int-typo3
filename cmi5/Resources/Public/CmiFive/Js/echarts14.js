function echarts14_(event, container, page, temp) {
...
function echartSetup(container, data_, temp) {
  ...
  let title = "Was glauben Sie, nach welchen Adressen wird oft gefragt?",
    subtext =
      "Ihre Bewertungen von 1 - 4. Rechts daneben sehen Sie die durchschnittliche Berwertung von anderen Teilnehmern zum Vergleich.";

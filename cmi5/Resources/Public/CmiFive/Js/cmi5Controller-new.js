var cmi5Controller = (function () {
  ...
  function GetBasicStatement(verb_, object_) {
    ...
    let descr; 
    if (!sessionStorage.getItem("descr")) {
      descr = object_.definition.description["0"];
      sessionStorage.setItem("descr", "true");
    }
    //else descr = object_.definition.description[cmi5Controller.dLang];
    delete object_.definition.name;
    delete object_.definition.description;
    object_.definition.name = {[cmi5Controller.dLang]: cmi5Controller.dTitle};
    if (!descr) descr = "Edit Descritpion of AU (optional)";
    object_.definition.description = {[cmi5Controller.dLang]: descr};
